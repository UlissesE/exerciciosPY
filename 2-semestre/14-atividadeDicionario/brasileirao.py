...
def nome_campeao(dados):
    ID_CAMPEAO = id_campeao(dados)
    NOME_CAMPEAO = nome_do_time(dados, ID_CAMPEAO)
...
def classificados_libertadores(dados):
    ...
    classificados = ids_dos_melhor_classificados(dados, QTD_LIBERTADORES)
...
def nomes_classificados_libertadores(dados):
    ...
    for id in id_classificados:
         nomes_classificados.append(nome_do_time(dados, id))
